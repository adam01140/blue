            ...
            async function loadCartItems() {
                ...
                try {
                    ...
                    for (const item of cart) {
                        ...
                        itemsHtml += '<div style="display:flex;justify-content:space-between;align-items:center;padding:12px 0;border-bottom:1px solid #e0e0e0;">' +
                            '<div style="flex:1;">' +
                                '<div style="font-weight:600;color:#2c3e50;">' + (item.title || 'Form') + '</div>' +
                                '<div style="font-size:0.9em;color:#7f8c8d;">' + (item.formId || '') + '</div>' +
                            '</div>' +
                            '<div style="text-align:right;">' +
                                '<div style="font-weight:600;color:#2c3e50;">$' + itemPrice.toFixed(2) + '</div>' +
                            '</div>' +
                        '</div>';
                    }
